...
export default function ControlPanel() {
    const isRunning = useRAMStore(state => state.isRunning);
    const currentTick = useRAMStore(state => state.currentTick);
    const play = useRAMStore(state => state.play);
    const pause = useRAMStore(state => state.pause);
    const reset = useRAMStore(state => state.reset);
    const tick = useRAMStore(state => state.tick);
