...
export default function ControlPanel() {
    const isRunning = useArchitectureStore(state => state.isRunning);
    const currentCycle = useArchitectureStore(state => state.currentCycle);
    const play = useArchitectureStore(state => state.play);
    const pause = useArchitectureStore(state => state.pause);
    const reset = useArchitectureStore(state => state.reset);
    const tick = useArchitectureStore(state => state.tick);

    const [speed, setSpeed] = React.useState(500); // ms per tick
