...
import PC_ARCHITECTURE_LEVELS from '../../levels/definitions/pc-architecture-levels';
import useProgressStore from '../../store/progressStore';

/**
 * PC Architecture Module with Level-Based Learning
 */
export default function PCArchitectureWithLevels() {
    ...
    const handleValidateNow = () => {
        ...
        if (result.passed) {
            updateLevelProgress('pc-architecture', currentLevel.id, {
                completed: true,
                stars: result.stars,
                attempts: 1,
    ...
    if (mode === 'level-select') {
        return (
            <LevelSelect
                levels={PC_ARCHITECTURE_LEVELS}
                moduleTitle="PC ARCHITECTURE"
                moduleSubtitle="Build Epic Computer Systems!"
