        ...
        let cycles = match opcode {
            ...
            0x33 => {
                match (funct3, funct7) {
                    ...
                    _ => {
                        web_sys::console::warn_1(&format!("Unknown R-type instruction: funct3={:x}, funct7={:x}", funct3, funct7).into());
                    }
                }
                self.pc += 4;
            ...
            0x13 => {
                ...
                match funct3 {
                    ...
                    _ => {
                        web_sys::console::warn_1(&format!("Unknown I-type instruction: funct3={:x}", funct3).into());
                    }
                }
                self.pc += 4;
